  ...
  return (
    <Navbar className="navbarStyle">
      <Nav>
        ...
        <NavItem eventKey={2} href="#"><i className="fa fa-car" /> Artists</NavItem>
        <NavItem eventKey={3} href="#"><i className="fa fa-gear" /> Sound</NavItem>
        <NavItem eventKey={4} href="#"><i className="fa fa-gear" /> Visual</NavItem>
